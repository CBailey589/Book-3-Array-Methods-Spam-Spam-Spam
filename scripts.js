...
//   From the customers array, extract just the customers' contact email addresses and store them in a new array.
// let emails = []
// emails = customers.map((customer) => {
//     let custEmails = (customer.contacts.email).map((email) => {
//         return email
//     })
//      return custEmails
// })
...
// console.log(emails)
// let emails = []
// findEmails = customers.map((customer) => {
//     let custEmails = (customer.contacts.email).map((email) => {
